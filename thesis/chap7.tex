...
Zhang and King~\cite{ZhangKing2002a,ZhangKing2002b} determined that by pre-processing a dataset with an appropriate graph structure (in this case, they chose a $\beta$-skeleton), they were able to drastically reduce the training set size for an SVM classifier thus reducing computation time, while maintaining simliar accuracy.
%
