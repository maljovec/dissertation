...
\begin{figure}[htbp]
    ...
    %
    Once an optimal setting is decided we compare it with aggregate quality measures of the other graphs.
    %
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l || c | c | c}
        Graph  & 4D Diagonal with 4 maxima & 5D Distance Field with 5 maxima & 5D Distance Field with 15 maxima \\
    \hline\hline
