...
\begin{figure}[t]
  \centering
  \includegraphics[width=.55\textwidth]{figs/chap1/pipeline}
...
%
The top box is the natural starting point where we must first identify what quantities of interest we are going to observe.
%
...
%
In this case, the decision may be to pursue a particular type of fuel for use in production or to use a reasonable approximation for more extensive testing at a reduced cost.
