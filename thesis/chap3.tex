...
\DPM{
\begin{itemize}
\item The problem of multicolinearity.
\item The problem of regularization.
\item The ridge $\alpha$ parameter to control complexity.
\item How LASSO helps in the face of sparse coefficients.
\item Elastic net
\item Least-Angle Regression (LARS)
\item Orthogonal matching pursuit (OMP)
\item others talked about here on scikit-learn %http://scikit-learn.org/stable/modules/linear_model.html
\item How to find literature on others?
\end{itemize}
}
