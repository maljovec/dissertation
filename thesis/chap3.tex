...
%
\DPM{Extract relevant data from Jupyter notebook using LDA. Relate Quadratic Discriminant Analysis (QDA).}

\DPM{Canonical Correlation Analysis (CCA)} - joint dimensionality reduction. Reduce two datasets while maintaining correlations.

\DPM{Sufficient Dimensionality Reduction} - 
