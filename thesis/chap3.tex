...
\DPM{This needs extended to cover the state of the art in SVM design including dealing with larger data sets including sequential minimal optimization, etc.}
