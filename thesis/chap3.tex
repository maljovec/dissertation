...
Another class of space-filling designs that have existed for a long time are quasi-random number sequences which have been used a lot for quasi Monte Carlo methods in numerical analysis~\cite{Niederreiter1992}.
%
These methods are also known as low-discrepancy sequences since they tend to create near equally distributed points, however as they are deterministic can result in repeating patterns.
%
The low discrepancy paradigm is similar in spirit to the category of blue-noise sampling, but using a different mathematical definition based on \textem{discrepancy} of points.
%
Examples include the one-dimensional Van der Corput sequence~\cite{vanderCorput1935}, its higher dimensional generalizations known as Halton sequences~\cite{Halton1964,BraatenWeller1979}, Hammersley sets~\cite{HammersleyHandscomb1964}, and Sobol sequences~\cite{Sobol1967}.
...
Many scientific datasets are presented as point sampled data of low to moderate ($<$100) dimensionality.
%
...
%
\DPM{Add citations of successful use of Neural Networks in practice.}
