...
We first review several traditional scoring functions which are used as a baseline comparison for our own topological scoring functions.
%
...
\para{Delta} This criterion can be seen as a way to evenly sample the range space of the function.
%
...
\para{ALM} This is the Active Learning MacKay criterion described in~\cite{MacKay1992} which attempts to optimize the predictive variance.
%
...
\para{EI} This is the expected improvement criterion.
%
...
\para{Distance Penalization} Each of the above three scoring functions can be augmented with a distance penalization factor, therefore creating three additional scoring functions, namely, \emph{DeltaDP}, \emph{ALMDP} and \emph{EIDP}.
%
...
\para{TopoHP} The first strategy is aimed at sampling at or near predicted critical points with significant influence on the topology.
%
...
\para{TopoP} Similar to a bootstrapping approach, this strategy aims to evaluate how much the topology (as represented by the persistences) would change if a new candidate point is added.
%
...
\para{TopoB} For each point $\x \in \Scal$, $TopoB(\x)$ is defined as the bottleneck distance between the persistence diagram of the Morse-Smale complex over $\Tcal$ versus the Morse-Smale complex consisting of $\Tcal \cup \x$.
%
...
\para{Example Data Sets} To evaluate the different scoring functions and understand the behavior in different scenarios we have conducted a series of experiments with well-known analytic functions, which can be generalized to high-dimensions.
%
...
\begin{figure}[!ht]
\begin{center}
%\subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Ackley/gpm_Ackley_td=20}\label{fig:ackley2D_gpm}}
%\subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Ackley/earth_Ackley_td=20}\label{fig:ackley2D_earth}}
%\subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Ackley/mda_Ackley_td=20}\label{fig:ackley2D_mda}}
%\subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Ackley/nnet_Ackley_td=20}\label{fig:ackley2D_nnet}}
...
\para{Discussions on Results} Unsurprisingly, the most significant factor in the success of any scoring function is the quality of the regression model.
%
...
\begin{figure}[htbp]
\begin{center}
% \subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Diag2Max/gpm_Diag2Max_td=20}\label{fig:2diag2D_gpm}}
% \subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Diag4Max/gpm_Diag4Max_td=20}\label{fig:4diag2D_gpm}}
% \subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/GMM5/gpm_GMM5_2D_td=20}\label{fig:gmm52D_gpm}}
% \subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/MGR/gpm_MGR_td=20}\label{fig:mgr2D_gpm}}
% \subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Salomon/gpm_Salomon_td=20}\label{fig:salomon2D_gpm}}
%\subfigure[]{\includegraphics[width=0.2425\linewidth]{./2D/Whitley/gpm_Whitley_td=20}\label{fig:whitley2D_gpm}}
 \includegraphics[width=0.2425\linewidth]{figs/chap5/gpm_Diag2Max_td=20}
 \includegraphics[width=0.2425\linewidth]{figs/chap5/gpm_Diag4Max_td=20}
 \includegraphics[width=0.2425\linewidth]{figs/chap5/gpm_GMM5_2D_td=20}
 \includegraphics[width=0.2425\linewidth]{figs/chap5/gpm_MGR_td=20}
 \includegraphics[width=0.2425\linewidth]{figs/chap5/gpm_Salomon_td=20}
 \includegraphics[width=0.2425\linewidth]{figs/chap5/gpm_Whitley_td=20}
\caption{Adaptive sampling various 2D test functions using the GPM.
(1) Two maxima Diagonal; (2) Four maxima Diagonal; (3) Mixture of five Gaussians; (4) MGR; (5) Salomon; (6) Whitley.}
...
\begin{figure}[htbp]
\begin{center}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/Ackley/gpm_Ackley_td=30}\label{fig:ackley3D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/Diag2Max/gpm_Diag2Max_3D_td=30}\label{fig:2diag3D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/GMM2/gpm_GMM2_3D_td=30}\label{fig:gmm23D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/GMM5/gpm_GMM5_3D_td=30}\label{fig:gmm53D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/MGR/gpm_MGR_td=30}\label{fig:mgr3D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./4D/Ackley/gpm_Ackley_td=100}\label{fig:ackley4D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./5D/Salomon/gpm_Salomon_td=200}\label{fig:salomon5D_gpm}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./5D/Diag2Max/gpm_Diag2Max_5D_td=200}\label{fig:2diag5D_gpm}}
...
\begin{figure}[htbp]
\begin{center}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/Diag2Max/earth_Diag2Max_td=20}\label{fig:2diag2D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/GMM5/earth_GMM5_2D_td=20}\label{fig:gmm52D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/MGR/earth_MGR_td=20}\label{fig:mgr2D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/Whitley/earth_Whitley_td=20}\label{fig:whitley2D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/Ackley/earth_Ackley_td=30}\label{fig:ackley3D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/Whitley/earth_Whitley_td=30}\label{fig:whitley3D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/MGR/earth_MGR_td=30}\label{fig:mgr3D_earth}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/GMM2/earth_GMM2_3D_td=30}\label{fig:gmm23D_earth}}
 \includegraphics[width=0.24\linewidth]{figs/chap5/earth_Diag2Max_td=20}
 \includegraphics[width=0.24\linewidth]{figs/chap5/earth_GMM5_2D_td=20}
 \includegraphics[width=0.24\linewidth]{figs/chap5/earth_MGR_td=20}
 \includegraphics[width=0.24\linewidth]{figs/chap5/earth_Whitley_td=20}
 \includegraphics[width=0.24\linewidth]{figs/chap5/earth_Ackley_td=30}
...
\begin{figure}[htbp]
\begin{center}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/Diag2Max/mda_Diag2Max_td=20}\label{fig:2diag2D_mda}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/GMM5/mda_GMM5_2D_td=20}\label{fig:gmm52D_mda}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/MGR/mda_MGR_td=20}\label{fig:mgr2D_mda}}
% \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/Whitley/mda_Whitley_td=20}\label{fig:whitley2D_mda}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/Ackley/mda_Ackley_td=30}\label{fig:ackley3D_mda}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/Whitley/mda_Whitley_td=30}\label{fig:whitley3D_mda}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/MGR/mda_MGR_td=30}\label{fig:mgr3D_mda}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./3D/GMM2/mda_GMM2_3D_td=30}\label{fig:gmm23D_mda}}
  \includegraphics[width=0.24\linewidth]{figs/chap5/mda_Diag2Max_td=20}
  \includegraphics[width=0.24\linewidth]{figs/chap5/mda_GMM5_2D_td=20}
  \includegraphics[width=0.24\linewidth]{figs/chap5/mda_MGR_td=20}
  \includegraphics[width=0.24\linewidth]{figs/chap5/mda_Whitley_td=20}
  \includegraphics[width=0.24\linewidth]{figs/chap5/mda_Ackley_td=30}
...
\begin{figure}[htbp]
\begin{center}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/Diag2Max/nnet_Diag2Max_td=20}\label{fig:2diag2D_nnet}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/GMM5/nnet_GMM5_2D_td=20}\label{fig:gmm52D_nnet}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/MGR/nnet_MGR_td=20}\label{fig:mgr2D_nnet}}
%  \subfigure[]{\includegraphics[width=0.24\linewidth]{./2D/Salomon/nnet_Salomon_td=20}\label{fig:salomon2D_nnet}}
...
\begin{figure}[htbp]
\begin{center}
%\includegraphics[width=0.24\linewidth]{./3D/Ackley/nnet_Ackley_td=30}\label{fig:ackley3D_nnet}
%\includegraphics[width=0.24\linewidth]{./3D/MGR/nnet_MGR_td=30}\label{fig:mgr3D_nnet}
%\includegraphics[width=0.24\linewidth]{./3D/Salomon/nnet_Salomon_td=30}\label{fig:salomon3D_nnet}
%\includegraphics[width=0.24\linewidth]{./3D/GMM2/nnet_GMM2_3D_td=30}\label{fig:gmm23D_nnet}
...
\para{Random Gaussian Mixture Model}
...
\para{Mis-scaled Generalized Rastrigin}
$$
...
For MDA, we use \texttt{mda} library in \texttt{R}, with the following parameters (see \cite{mda} for details, non-listed parameters use package defaults),
\begin{code}
degree=3 // Maximum degree of interaction (Friedman's mi)
...
\While{$C \neq \emptyset$ and not converged}
  \State{$M \gets [T,f(T)]$}\Comment{Build a surrogate $M$ with the training
                                     data}
  \State{$ R \gets$ \textbf{SELECT}($C$, $S$, $M$, $b$) }\Comment{This is the
                                                                  step we will
                                                                  be augmenting}
...
\paragraph{Topology-Based Batch Selection: Points with Maximum Persistence.}
...
Since we would like to generalize our batch selection process to any arbitrary dimension, we compute an approximated Morse complex of the scoring function to estimate the location of its local maxima and their corresponding persistence.
...
%\State{}\Comment{The parameter $m$ sets the number of maxima to chose before
%refitting the surrogate, thus $m=b$ means the MaxP strategy in our experimental
% results section.}
...
\subsubsection{Results for Limit Surface Recovery}
...
%\begin{figure}[!ht]
%\centering
%\includegraphics[width=0.24\textwidth]{believe_Model_152}
%\includegraphics[width=0.24\textwidth]{believe_Score_152}
%\includegraphics[width=0.24\textwidth]{maxp_Model_152}
%\includegraphics[width=0.24\textwidth]{maxp_Score_152}\\
%\includegraphics[width=0.24\textwidth]{grayscale}
%\includegraphics[width=0.24\textwidth]{score}
%\includegraphics[width=0.24\textwidth]{grayscale}
%\includegraphics[width=0.24\textwidth]{score}
%\caption{These images are snapshots of the predicted response surface and the
%scoring landscape where 152 points have already been added to the original 100
%training points.
%%
%The grayscale images correspond to the model surface, and the colored images
%represent the scoring function. The yellow contours denote the predicted limit
%surface.
%%
%The blue points are the training data (the same for both trials) and the red
%points are the adaptively selected points.
%%
%The green points represent the next batch of 8 selected points.
%%
%Note, the left two images are the Believe strategy, whereas the right images
%are the MaxP strategy.
%%
%The  Believe strategy can still select points clustered in a single region
%potentially limiting the amount of information gain from a single batch.}
%\label{fig:exampleLimits}
%\end{figure}
...
The Hausdorff distance metric shows even for the more simple test cases that the topology-based methods perform relatively well.
%
...
We now introduce a predominantly qualitative study of adaptive sampling for limit surface extraction geared at nuclear simulation data.
%
We begin with a brief introduction of the problem space before presenting a collection of modified adaptive sampling pipelines along with results on a series 2D of problems.
...
For DPRA, propagation of uncertainties in the analysis of complex systems employs sampling algorithms which perform a series of simulation runs given a set of uncertainty parameters.
%
However, typically the set of uncertain parameters is very large and the computational cost of each run is very high.
%
Consequently, the space of the possible solutions, the response surface, can be sampled only very sparsely and this precludes the ability to fully analyze the impact of uncertainties on the system.
%
...
Currently, the class of most used sampling algorithms include: classic stochastic sampling (e.g., Monte-Carlo \cite{Hastings1970,Liu2001}, stratified sampling such as Latin hypercube sampling \cite{HeltonDavis2003}, importance sampling~\cite{Geweke1989} and orthogonal arrays based~\cite{Owen1992} algorithms) and deterministic algorithms (e.g., Polynomial Chaos Expansions \cite{Najm2009} and Quasi Monte-Carlo \cite{Caflisch1998}).
%
However, all of these sampling algorithms do not possess a sampling strategy that explicitly takes into account the results of previous simulations.
%
Adaptive sampling algorithms, on the other hand, adopt a sampling strategy that chooses the next sample based on the results obtained by previous samples through a statistical learning model and, thus, focus sampling in risk sensitive regions such as boundaries between system safe and system failure: the limit surface.

In this section, we present three adaptive sampling models that can be used to infer the behavior of system by estimating the limit surface.
%
...
%
The final model is designed to be completely data-driven. It computes a candidate set directly from the neighborhood graph constructed from the training data, without any dependencies on a particular prediction model.
%
...
\vspace{-5mm}
\caption{General adaptive sampling pipeline and pipelines for $\Mone$, $\Mtwo$ and $\Mthree$ respectively.}
\label{fig:pipelines}
\end{figure}
...
%
Next, we fit a response surface surrogate model from the initial set of training data.
%
Third, a pool of candidate points is chosen in the parameter space based on a specified sampling technique, and the surrogate model is evaluated at these locations, obtaining a set of approximated values.
%
...
%
% Two main families of PMs are used in uncertainty quantification: regression models such as Multivariate Adaptive Regression Splines (MARS) and stochastic models such as Gaussian processes.
%
Both $\Mone$ and $\Mtwo$ use an (\DPM{easily replaceable}) prediction model, i.e. a Gaussian process model (GPM), as the surrogate model.
%
We use a specific implementation known as the Sparse Online Gaussian Process~\cite{CsatoOpper2002}.
%
...
%
CVT samples cover the domain relatively densely but are sparser than points obtained by Latin Hypercube Sampling (LHS). \DPM{As mentioned earlier}
...
%
An edge in a relaxed Gabriel graph is a \emph{spanning edge} if it spans the threshold value $t$ in the range space, in other words, if its endpoints have function values on the opposite sides of $t$.
%
...
\vspace{-5mm}
\caption{From top to bottom: Synthetic datasets $\SA$, $\SB$ and $\SC$.
For each dataset: (a) Surface rendering of the true response model and the true limit surface; Adaptively sampled points and training points at the end of the process under (b) $\Mone$, (c) $\Mtwo$ and (d) $\Mthree$;
Limit surfaces extracted from (e) the true response model, (f) $\Mone$, (g) $\Mtwo$ and (h) $\Mthree$.
...
\vspace{-5mm}
\caption{Synthetic datasets $\SD$ (top) and $\SE$ (bottom).
For each dataset: (a) Surface rendering of the true response model and the true limit surface; Adaptively sampled points and training points at the end of the process under (b) $\Mone$, (c) $\Mtwo$ and (d) $\Mthree$;
Limit surfaces extracted from (e) the true response model, (f) $\Mone$, (g) $\Mtwo$ and (h) $\Mthree$.
Initial training (adaptive sampled) points are solid triangles (circles), colored by true (estimated)  responses.
}
...
\vspace{-2mm}
\caption{
$\Mtwo$ for $\SD$: Increasing limit surface tolerance parameter $\delta$
...
\vspace{-5mm}
\caption{Nuclear dataset $\NF$.
(a) Surface rendering of the true response model and the true limit surface; Adaptively sampled points and training points at the end of the process under (b) $\Mone$, (c) $\Mtwo$ and (d) $\Mthree$;
Limit surfaces extracted from (e) the true response model, (f) $\Mone$, (g) $\Mtwo$ and (h) $\Mthree$.
Initial training (adaptive sampled) points are solid triangles (circles), colored by true (estimated) responses.}
\label{fig:nuclear-F}
\end{figure}
...
\vspace{-4mm}
\caption{$\NF$: Example of a transient for a LOOP scenario.}
...
\vspace{-3mm}
\caption{Convergence of estimated response surfaces and estimated limit surfaces for $\NF$,  with all three models. Images are obtained after every additional $10$ adaptively sampled points.
}
...
\subsubsection{RMSE Convergence for $\Mone$ and $\Mtwo$}
...
\vspace{-5mm}
\caption{Convergence of RMSE of the estimated limit surfaces based on $\Mone$ and $\Mtwo$ for a single trial.
}
...
\vspace{-5mm}
\caption{Convergence of mean RMSE of the estimated limit surfaces based on $\Mone$ and $\Mtwo$ across $10$ trials.
}
\label{fig:RMSE-mean}
\end{figure}
...
\vspace{-5mm}
\caption{Convergence of median RMSE of the estimated limit surfaces based on $\Mone$ and $\Mtwo$ across $10$ trials.
}
...
\section{Summary}
\DPM{Summarize how this all culminates to create new ways of thinking about adaptive sampling.}
