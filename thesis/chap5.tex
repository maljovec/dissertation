...
\caption{Adaptive sampling of the two-dimensional Ackley function using different regression techniques and different scoring functions. (1) GPM; (2) EARTH; (3) MDA; and (4) NNET.}
...
\begin{center}
 ...
 \caption{Adaptive sampling various two-dimensional test functions using the GPM. (1) Two maxima Diagonal; (2) Four maxima Diagonal; (3) Mixture of five Gaussians; (4) MGR; (5) Salomon; (6) Whitley.}
...
%
(1) three-dimensional Ackley;
(2) three-dimensional two maxima Diagonal;
(3) three-dimensional mixture of two Gaussians;
(4) three-dimensional mixture of five Gaussians;
(5) three-dimensional MGR;
(6) four-dimensional Ackley;
(7) five-dimensional Salomon;
(8) five-dimensional two maxima Diagonal function.}
\label{fig:345D_gpm}
\end{center}
\end{figure}
...
%
Interestingly, in its three-dimensional incarnation the adaptive sampling does not work nearly as well and furthermore shows excessive variations in several curves.
...
(1) two-dimensional two maxima Diagonal function;
(2) two-dimensional mixture of five Gaussians;
(3) two-dimensional MGR function;
(4) two-dimensional Whitley functions;
(5) three-dimensional Ackley function;
(6) three-dimensional Whitley function;
(7) three-dimensional MGR function;
(8) three-dimensional mixture of two Gaussians.}
...
(1) two-dimensional two maxima Diagonal;
(2) two-dimensional mixture of five Gaussians;
(3) two-dimensional MGR function;
(4) two-dimensional Whitley function;
(5) three-dimensional Ackley function;
(6) three-dimensional Whitley function;
(7) three-dimensional MGR function;
(8) three-dimensional mixture of two Gaussians.}
...
\caption{Adaptive sampling of various two-dimensional test functions using the NNET model.
...
The three-dimensional Ackley and Salomon function both show the high variability and high RMSE with no adaptive scoring functions able to outperform the space-filling sampling.
%
Just as with the two MARS implementations the three-dimensional mixture of two Gaussians does not improve with increasing number of samples and shows the initial increase in RMSE for some scoring functions.
