...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$\Mone$: Global Prediction Model Limit Surface Recovery.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$\Mtwo$: Topology-Based Prediction Model Limit Surface Recovery.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$\Mthree$: Data-Driven Limit Surface Recovery.}
